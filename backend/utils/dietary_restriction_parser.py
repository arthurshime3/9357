...
for ind in range(numRows):
    ...
    Restriction(name = "Carbohydrates", value = float(nutrientRows[ind][5]) * float(nutrientRows[ind][1]) / 4, unit = 'g', is_min = True, is_multiplier = True),
    Restriction(name = "Carbohydrates", value = float(nutrientRows[ind][6]) * float(nutrientRows[ind][2]) / 4, unit = 'g', is_multiplier = True),
    Restriction(name = "Fat", value = float(nutrientRows[ind][7]) * float(nutrientRows[ind][1]) / 9, unit = 'g', is_min = True, is_multiplier = True),
    ...
    Restriction(name = "Calcium", value = 1000 * float(nutrientRows[ind][15]), unit = 'mg', is_min = True),
    Restriction(name = "Calcium", value = None, unit = 'mg'),
    ...
    Restriction(name = "Folate", value = 1000000 * float(nutrientRows[ind][49]), unit = 'mmg', is_min = True),
    Restriction(name = "Folate", value = None, unit = 'mmg'),
    ...
    Restriction(name = "Selenium", value = 1000000 * float(nutrientRows[ind][65]), unit = 'mmg', is_min = True),
    Restriction(name = "Selenium", value = None, unit = 'mmg'),
